          ...
          <>
                ...
                <table className="w-full">
                  <thead>
                    <tr className="bg-slate-50">
                      ...
                      <th className="text-left px-6 py-3 text-xs font-semibold text-slate-500 uppercase tracking-wider">Entity Type</th>
            ...
            <div className="mt-6 grid grid-cols-3 gap-4">
              <a href="/admin/companies" className="p-4 bg-white rounded-xl border border-slate-200 shadow-sm hover:border-primary-300 hover:bg-primary-50/50 transition-colors flex items-center gap-3">
                ...
                <span className="text-sm font-medium text-slate-700">Verify Companies ({metrics?.pendingCompanies || 0} pending)</span>
              </a>
