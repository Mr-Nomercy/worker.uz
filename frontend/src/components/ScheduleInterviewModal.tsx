...
interface ScheduleInterviewModalProps {
  ...
  jobTitle: string;
  onSubmit: (data: { date: string; time: string; type: "video" | "phone" | "onsite" }) => void;
}

export function ScheduleInterviewModal({ isOpen, onClose, candidate, jobTitle, onSubmit }: ScheduleInterviewModalProps) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-2xl shadow-xl w-full max-w-md mx-4 p-6">
        ...
        <div className="bg-slate-50 rounded-xl p-4 mb-6">
          ...
          <p className="text-sm text-slate-500 mt-2">For position: <span className="text-slate-700">{jobTitle}</span></p>
        </div>
